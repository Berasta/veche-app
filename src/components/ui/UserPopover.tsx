...
export function UserPopover({
  ...
  const bannerUrl = useMemo(
    () => getBannerUrl(bannerId, userId),
    [bannerId, userId],
  );
  const bannerPos = useMemo(
    () => (bannerUrl ? loadBannerPosition(bannerId) : null),
    [bannerId],
  );
            ...
            >
              ...
              <div className="relative w-full aspect-[2.5/1] rounded-t-2xl overflow-hidden bg-black/10">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-2 p-3">
                  ...
                  <div className="inline-block px-1.5 py-0.5 rounded-md bg-black/30 backdrop-blur-sm">
                    <p className="text-sm font-bold text-white drop-shadow-lg truncate leading-tight max-w-[90%] text-center">
                      {username}
                    </p>
                  </div>
                </div>

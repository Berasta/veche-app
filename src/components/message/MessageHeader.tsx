...
export function MessageHeader({ author, avatar, time, role, roleColor, bannerId, joinedAt }: MessageHeaderProps) {
  const initials = author.charAt(0).toUpperCase();

  return (
    <div className="flex items-center gap-2 mb-1">
      <UserPopover username={author} avatarUrl={avatar} bannerId={bannerId} role={role} roleColor={roleColor} joinedAt={joinedAt}>
